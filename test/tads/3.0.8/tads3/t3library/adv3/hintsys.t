...
/* Copyright (c) 2000, 2003 by Michael J. Roberts.  All Rights Reserved. */
/*
 ...
 *   
 *   This module depends on the menus module to display the user
 *   interface.  
 */
...
hintManager: PreinitObject
    ...
    disableHints()
    {
        ...
        /* acknowledge it */
        mainReport(libMessages.hintsDisabled);
    }
