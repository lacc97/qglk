#ifdef RCSID
static char RCSid[] =
"$Header: d:/cvsroot/tads/TADS2/unix/oemunix.c,v 1.3 1999/05/29 15:51:03 MJRoberts Exp $";
#endif
 ...
 *   
 *   The default frmat looks like this:
 *   
 ...
 *   with accolades.
 *   
 *   You should include a newline at the end of the line.  The newline is
 *   not assumed, so that this string can be left completely empty without
 *   generating an extra blank line.
 *   
 *   For example:
 *   
 *   "FrobTADS copyright 1998 by L.J.Teeterwaller <teeter@omegatron.com>\n"
 ...
 */
char G_tads_oem_author[] = SYSMAINTAINER;
